        ...
        <div class="mt-6 grid grid-cols- gap-6 xl:grid-cols-1">
            ...
            <div class="flex flex-col mt-8">
                <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                    <form action="{{ route('adminNilaiCari') }}" class="px-8" method="GET">
                        <div class="pb-4 flex flex-row md:flex-col justify-between">
                            <button type="button"
                                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 md:p-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                <a href="{{ route('adminNilai.create') }}">
                                    Input Nilai
                                </a>
                            </button>
                            ...
                            <tbody class="bg-white">
                                @foreach ($nilai as $key => $value)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                            <div class="text-sm leading-5 text-gray-500"> {{ $value->admin->pembina->bidang_kerja }}
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                            <div class="text-sm leading-5 text-gray-500"> {{ $value->nilai }}
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                            <div class="text-sm leading-5 text-gray-500"> {{ $value->keterangan }}
                                            </div>
                                        </td>
                                        ...
                                        <td
                                            ...
                                            <a href="{{ route('adminNilai.edit', $value->id) }}">
                                        ...
                                        <td
                                            ...
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                action="{{ route('adminNilai.destroy', $value->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit">
