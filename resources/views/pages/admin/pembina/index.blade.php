        ...
        <div class="mt-6 grid grid-cols- gap-6 xl:grid-cols-1">
            ...
            <div class="flex flex-col mt-8">
                <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                    <form action="{{ route('adminPembinaCari') }}" class="px-8" method="GET">
                        <div class="pb-4 flex flex-row md:flex-col justify-between">
                            <button type="button"
                                ...
                                <a href="{{ route('adminPembina.create') }}">
                                    Tambah Data Pembina
                                </a>
                            </button>
                            ...
                            <tbody class="bg-white">
                                @foreach ($pembina as $key => $value)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                            <div class="text-sm leading-5 text-gray-500"> {{ $value->no_hp }}
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                        ...
                                        <td
                                            ...
                                            <a href="{{ route('adminPembina.edit', $value->id) }}">
                                        ...
                                        <td
                                            ...
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                action="{{ route('adminPembina.destroy', ["id" => $value->id, "kerja_praktek_id" => $value->kerja_praktek_id]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit">
